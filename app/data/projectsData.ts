...
export const projectsData: Project[] = [
    ...
    // },
    {
        ...
        date: "",
        tags: ["C++", "ML", "Biology"],
        title: "Genetic Polynomial Optimisation",
        summary: "Zbigniew Michalewicz's genetic algoithms.",
        description: "",
        document: "genetic.html",
    },
    {
        slug: "netIntr",
        name: "High Performance Network Intrusion Detection System",
        image: "/images/projects/netIntr/background.jpg",
        date: "2025-01-10",
        tags: ["C", "AVX2", "OpenMP", "libpcap"],
        title: "Network Intrusion Detection",
        summary: "Low-latency C packet sniffer",
        description: "",
        document: "netIntr.html",
    },
    {
        slug: "fakeNews",
        name: "Fake News Detector",
        image: "/images/projects/fakeNews/background.jpg",
        date: "",
        tags: ["MCP", "MongoDB", "TypeScript", "Next.js"],
        title: "Fake News Detector",
        summary: "ICHack 2025 Anthropic Challenge",
        description: "",
        document: "fakeNews.html",
    },
    {
        slug: "spaceGame",
        name: "Game Development Studios",
        image: "/images/projects/spaceGame/background.png",
        date: "",
        tags: ["C#", "Unity", "C++", "Blender"],
        title: "Game Development Studios",
        summary: 'The "Pilot" game',
        description: "",
        document: "spaceGame.html",
    },
    {
        slug: "gpt-2",
